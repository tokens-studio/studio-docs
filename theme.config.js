...
export default {
  projectLink: 'https://github.com/tokens-studio/studio-docs',
  projectChatLink: 'https://tokens.studio/slack',
  projectChatLinkIcon: <Slack />,
  docsRepositoryBase: 'https://github.com/tokens-studio/studio-docs/blob/master',
  titleSuffix: ' – Tokens Studio',
  chat: false,
  logo: (
    <>
      <img src="/logo.svg" alt="Tokens Studio Logo" className="mr-2 mt-0"/>
  ...
  head: ({ title, meta }) => {
    ...
    const ogImage = `https://img.websnap.app/?url=https://docs.app.tokens.studio${path}&token=D5rpX7VfD3dACoyb&viewport_width=1200&viewport_height=630`;
    const ogTitle = title ? `${title} – Tokens Studio Docs` : 'Tokens Studio Docs';
    return (
      <>
        ...
        <meta name="description" content="Tokens Studio  - Documentation" />
        <meta name="og:description" content="Tokens Studio - Documentation" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content={ogImage} />
        <meta name="twitter:site:domain" content="docs.app.tokens.studio" />
        <meta name="twitter:url" content="https://docs.app.tokens.studio" />
  ...
  footerText: (
    <div className="flex items-center flex-wrap gap-3">
      <div>© {new Date().getFullYear()} Tokens Studio</div>
    </div>
  )
};
